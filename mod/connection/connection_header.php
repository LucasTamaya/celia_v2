...
$html .= '        <input class="w-full p-2 border rounded" type="text" name="email" id="email" placeholder="Email"/>';
$html .= '        <input class="w-full p-2 border rounded" type="password" name="password" id="password" placeholder="Mot de passe"/>';
