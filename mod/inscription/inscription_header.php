...
$html .= '           <input class="w-full p-2 border rounded" type="text" placeholder="Nom" name="form_nom" value="' . $data['nom'] . '"/>';
$html .= '           <input class="w-full p-2 border rounded" type="text" placeholder="Prénom" name="form_prenom" value="' . $data['prenom'] . '"/>';
$html .= '           <input class="w-full p-2 border rounded" type="email" placeholder="Email" name="form_email" value="' . $data['email'] . '"/>';
$html .= '           <input class="w-full p-2 border rounded" type="password" placeholder="Mot de passe" name="form_password" value=""/>';
$html .= '           <button class="w-full py-2 rounded text-white bg-blue-900" type="submit" name="">Enregistrer</button>';
$html .= '      </form>';
